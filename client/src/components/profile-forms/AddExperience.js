...
const AddExperience = props => {
    ...
    const{ company, title, location, from , to , current, descripion} = formDate;
...
<Fragment class="container">
      ...
      <form class="form" onChange= {(e)=>onChange(e)}>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <p><input type="checkbox" name="current" value=""value={current} onChange= {(e)=>onChange(e)} /> Current Job</p>
        </div>
        <div class="form-group">
          <h4>To Date</h4>
        ...
        <input type="submit" class="btn btn-primary my-1"  onChange= {(e)=>onChange(e)}/>
